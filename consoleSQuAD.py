...
model_answers =  model(['DandyGames это студия празработки игр основанная в 2021 году, идея основания появилась в 2019 году.'
                        'Студия аннонсировала 2 проекта LabsOfFate и GameOfGods, '
                        'ведущий геймдизайнер студии какое-то время работал над проектом VirsenСтудия находится по адресу ул. Пушкина дом Колотушкина. '
